...
- (id)initWithName:(NSString *)name topButtonText:(NSString *)topText bottomButtonText:(NSString *)bottomText
{
    ...
    if (self) {
        ...
        NSArray *buttons = [BCTwoButtonView getTopAndBottomButtonsWithSuperviewFrame:self.frame];
...
+ (NSArray *)getTopAndBottomButtonsWithSuperviewFrame:(CGRect)superviewFrame
{
    ...
    UIButton *topButton = [[UIButton alloc] initWithFrame:CGRectMake(20, superviewFrame.size.height/2 - buttonHeight - DEFAULT_HEADER_HEIGHT, superviewFrame.size.width - 40, buttonHeight)];
    ...
    UIButton *bottomButton = [[UIButton alloc] initWithFrame:CGRectMake(20, topButton.frame.origin.y + topButton.frame.size.height + 16, superviewFrame.size.width - 40, buttonHeight)];
