...
-(id)init
{
    ...
    if (self) {
        ...
        self.createWalletButton.accessibilityLabel = ACCESSIBILITY_LABEL_CREATE_NEW_WALLET;
        ...
        self.existingWalletButton.accessibilityLabel = ACCESSIBILITY_LABEL_LOG_IN;
