...
#define BC_STRING_BLOCK_TOR NSLocalizedString(@"Block TORs", nil)
#define BC_STRING_TOR_BLOCKED NSLocalizedString(@"TORs Blocked", nil)
#define BC_STRING_TOR_ALLOWED NSLocalizedString(@"TORs Allowed", nil)
