...
#define BC_STRING_EXCHANGE_DESCRIPTION_SENDING_FUNDS NSLocalizedString(@"Exchanges can take up to two hours, you can keep track of your exchange progress in the Order History. Once the trade is complete, your ether will arrive in your wallet.", nil)
