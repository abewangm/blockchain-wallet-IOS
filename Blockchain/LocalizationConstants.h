...
#define BC_STRING_PROMPT_REASON_RECEIVE_NAME_ARGUMENT_AMOUNT_ARGUMENT_NAME_ARGUMENT NSLocalizedString(@"Why would you like %@ to send you %@ (This will be shared with %@)?", nil)
#define BC_STRING_PROMPT_REASON_SEND_NAME_ARGUMENT_AMOUNT_ARGUMENT_NAME_ARGUMENT NSLocalizedString(@"Why would you like to send %@ %@ (This will be shared with %@)?", nil)
