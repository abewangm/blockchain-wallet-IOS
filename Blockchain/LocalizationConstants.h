...
#define BC_STRING_UPGRADE_FEATURES NSLocalizedString(@"The upgrade takes just a second and your bitcoins and history will be safe. Here is what’s better:\n\n\u2022 Completely updated design and user experience\n\u2022 Robust security center\n\u2022 Enhanced Privacy\n\u2022 Simplified backup and recovery\n\u2022 Customized fund management\n\nTwo advanced transaction types (Spending from watch-only addresses and Shared Coin) are not supported in the new version at this time.", @"Please keep these line breaks and bullet points consistent with each translation.")
#define BC_STRING_UPGRADE_TITLE NSLocalizedString(@"Confirm Upgrade", nil)
#define BC_STRING_UPGRADE_WARNING NSLocalizedString(@"Note that once upgraded, you cannot go back to the previous version, but all your bitcoins and your transaction history will be kept.", nil)
...
#define BC_STRING_SETTINGS_NOTIFICATIONS_FOOTER NSLocalizedString(@"Enable notifications to receive an email whenever you receive bitcoins. Only labeled addresses and imported addresses are eligible to trigger notifications.", nil)
...
#define BC_STRING_ADD_WATCH_ONLY_ADDRESS_WARNING NSLocalizedString(@"You are about to import a watch-only address. That means you can only access these funds if you have the private key stored elsewhere. If you do not have a paper wallet or other backup you should not instruct anyone to send you coins to this address. This is recommended for advanced users only. Continue?", nil)
