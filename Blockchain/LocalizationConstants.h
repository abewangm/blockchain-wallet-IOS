...
#define TRANSACTION_STARTED_TITLE NSLocalizedString(@"Transaction Started", nil)
#define TRANSACTION_STARTED_SUBTITLE_CONTACT_NAME_ARGUMENT NSLocalizedString(@"We have notified %@ about your request to start a transaction.", nil)
