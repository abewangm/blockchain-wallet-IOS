...
#define BC_STRING_SENT_INVITATIONS NSLocalizedString(@"Sent Invitations", nil)
#define BC_STRING_RECEIVED_INVITATIONS NSLocalizedString(@"Received Invitations", nil)
