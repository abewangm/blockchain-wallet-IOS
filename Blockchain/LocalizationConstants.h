...
#define BC_STRING_OVERVIEW_RECEIVE_BITCOIN_MESSAGE NSLocalizedString (@"Send your wallet address to a friend to request bitcoin. An address is a string of random letters and numbers that change for each transaction.", nil)
#define BC_STRING_OVERVIEW_QR_CODES_TITLE NSLocalizedString(@"QR Codes", nil)
#define BC_STRING_OVERVIEW_QR_CODES_MESSAGE NSLocalizedString(@"An address can also be shown as a QR code. Scan a friend's QR code to quickly capture their wallet address.", nil)
