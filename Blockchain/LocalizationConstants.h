...
#define BC_STRING_CONFIRM_SWEEP_MESSAGE_WANT_TO_SEND_ARGUMENT_BALANCE_ARGUMENT_FEE_ARGUMENT_SEND_ARGUMENT NSLocalizedString(@"The amount you want to send (%@), is greater than your balance (%@) minus the fee (%@). Would you like to send %@?", nil)
