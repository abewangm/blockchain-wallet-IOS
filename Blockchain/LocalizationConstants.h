...
#define BC_STRING_ARCHIVING_ADDRESSES_ARGUMENT_OF_ARGUMENT NSLocalizedString(@"Archiving Addresses: Address %d of %d", nil)
...
#define BC_STRING_UPGRADE_FEATURES_WHATS_BETTER NSLocalizedString(@"The upgrade takes just a second and your bitcoins and history will be safe. Here is what’s better:", nil)
...
#define BC_STRING_UPGRADE_FEATURES_SHARED_COIN_NOT_SUPPORTED NSLocalizedString(@"Shared Coin is not supported in the new version at this time.", nil)
